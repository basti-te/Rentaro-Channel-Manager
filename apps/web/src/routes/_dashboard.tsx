...
const NAV: NavItem[] = [
  ...
  { to: '/posteingang', label: 'Messages',       icon: Inbox },
  { to: '/messages',   label: 'Nachrichten-Archiv', icon: MessageSquare },
  { to: '/ki-gastnachrichten', label: 'KI-Gastnachrichten', icon: Sparkles },
